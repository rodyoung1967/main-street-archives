...
| --- | --- | --- | --- | --- | --- |
| 6 Apr. 1900 | Palace Saloon / Albert Knapp | `BUS-024` | `E-154` | Very High for reported purchase | Opposite post office/on a corner; no number or deed; planned refit not completed-construction proof. |
...
| 19 Jul. 1907 | Palace Saloon | `BUS-024` | `E-156` | Very High for Fifth Street wording | Described on Fifth Street; no number/proprietor; not assigned to 501. |
...
| 28 Mar. 1958 | Wheel Cafe & Lounge | `BUS-004` | `E-259` / `S-285` | Very High / visually verified exact address | Direct ad: **503 Main St., Ph: 9106**. Earliest currently recovered exact-address Wheel advertisement; not opening/ownership/transfer date. |
| 16 May 1958 | Wheel Cafe & Lounge | `BUS-004` | `E-256` / `S-283` | Very High / visually verified exact address | Direct ad: **503 Main St., Ph: 9106**. Earliest currently recovered exact-address Wheel advertisement; not an opening date and no proprietor/licensee named. |
...
| Before 7 Jun. 1967; exact preceding-meeting date unresolved | The Wheel | `BUS-004` | `E-025` | Very High for address/action; applicant/type unresolved | Commission authorizes the mayor to sign a liquor application for **the Wheel at 503 Main**. Applicant/licensee and application type are not stated; this action does **not** date a LaFarlette acquisition. |
| Date unresolved | Raye LaFarlette / Raye Grisham ownership of The Wheel | `BUS-004` | `E-022` | High family / project-steward evidence | Family evidence establishes that Raye bought The Wheel at 503. Exact acquisition date, seller, licensee form, and transaction mechanism remain unresolved; do **not** anchor this ownership fact to the 1967 liquor action without a direct bridge. |
...
| 8 Apr. 1921–30 Jun. 1922 | Dr. Freeze, Eye Specialist | `BUS-021` | `E-028`, `E-137`, `E-345` | Very High | 505 / 505½; exact new 505½ anchors on 13 Jan., 3 Feb. and 9 Feb. 1922 supplement the prior endpoints; later Masonic Building. |
| 1925 | Billiards and cigars (Sanborn) | | `E-020` | High map | |
| 1936 photographic state; 1934 residence context | Farr's Pool Hall | `BUS-013` | `E-033`, `E-210` | Strong cross-source inference for 1936; official-secondary business identity | CCHS `P-1128` is independently dated 1936; steward mapping plus probable `FARR'S` / likely pool-related signage, combined with the City business/address evidence, strongly supports Farr's operating at 505 in 1936. The 1934 residence acquisition is not a business opening date. |
...
| 1973–1987 | Brass Rail / Hansen→Wiitanen interval | `BUS-010` | `E-022`, `E-031`, `E-038`, `E-046`–`E-049` | High family; partial documentary anchors | Aug. 2026 targeted pass found no new Brass Rail or Hansen sale record online. See `evidence/source-captures/1973-1987-503-505-research-pass.md` and `RL-041`. |
...
| By Dec. 1920–July 1922 | Fifth/Main cluster; number unresolved | May & Washburn garage | `BUS-069` | `E-103`, `E-347` | A 16 Feb. joint horseshoeing ad with S. F. Scripture proves commercial association only. Do not assign Scripture's separately advertised 108 Fifth address or infer merger/succession/May identity. |
...
| --- | --- | --- | --- | --- | --- |
| 6 Apr.–28 Sep. 1917 verified span | Main Street between Fourth and Fifth | Fashion Stable / W. S. Eddy | `BUS-103` / `P-396` | latest `E-262` / `S-288` | Direct relative-location wording; no number or target-building continuity. |
...
| 11 Apr. 1919 | 507½ Main | Ohio Dentists / Dr. J. G. Nash | `BUS-106` | `E-266` | Direct ad says 507½ Main, over Harding's Drug Store; Harding's ground-floor number not printed. |
...
| 16 May 1919 | Sandy area; exact address not printed | New confectionery / “Wolf building” alterations | Unresolved Sandy business | `E-267` | Full-page visual context places the item inside the Sandy Department. It is not an Oregon City/503/505 event; do not assign it to BUS-012 or S. Wolf. |
...
| 29 Aug. 1919 | 210 Seventh Street | Theroux Music House | `BUS-029` | `E-270` | August Enterprise advertising directly continues the published address through 29 Aug. |
| Aug. 1919 | address not printed | Farr Brothers market-report provider | `BUS-104` | `E-270` | All five Enterprise issues credit Farr Brothers with Brady Mercantile; no individual proprietor/address bridge to 505. |

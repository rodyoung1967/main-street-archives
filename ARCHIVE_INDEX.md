...
## Recommended First-Time Reading Path
...
Latest 1922 targeted checkpoint: [Task 7 model test](evidence/source-captures/1922-task-7-fire-origin-model-test-2026-08-28.md) and [Task 8 handoff](evidence/source-captures/1922-task-8-integration-handoff-2026-08-28.md). Neither fire/boundary model is selected; 501 remains live. The handoff lists remaining online work and eight manual callouts; 1922 is explicitly **IN PROGRESS**. The [Tasks 5–6 identity audit](evidence/source-captures/1922-tasks-5-6-identity-review-2026-08-28.md) (`E-113`, `S-125`–`S-127`) preserves the direct Springfield [Gilbert Miller](people/profiles/gilbert-miller.md) association and unmerged Wolf/Gates candidates. The [Victor John Wolf identity control](evidence/source-captures/1922-06-26-victor-john-wolf-naturalization-identity-control.md) (`E-281`, `S-308`–`S-309`, `P-399`) sharpens one candidate but does not identify S. Wolf: Victor was reported at Oregon City Route 6 on 26 June, while the July buyer was described as S. Wolf of Portland. The [10 September continuation handoff](evidence/source-captures/2026-09-10-george-newton-427-main-s-wolf-continuation-handoff.md) consolidates the Newton→427 working hypothesis, Victor separation, completed [OHRI bounded audit](evidence/source-captures/2026-09-10-s-wolf-ohri-bounded-index-audit.md), and the deed/title/assessment-first next research order.
...
1926 Kwality source-provenance advance: [15 September re-survey review](evidence/source-captures/2000-resurvey-1926-kwality-newspaper-provenance-2026-09-15.md) shows that the **2000 downtown re-survey generated 59 individual historic-resource forms**, with City copies and SHPO originals; its methodology names newspaper research at Oregon City Public Library/CCHS/UO/OSU, and its selected bibliography explicitly lists **Oregon City Enterprise (daily and weekly newspapers)**. Oregon City Public Library now confirms both Enterprise-family microfilm runs span all of **1926** (`S-374`). Highest-value next step is **MF-068: retrieve the individual 503 Main / Kwality Cafe survey form and source notes**; if no exact citation survives, continue with **MF-031: 1926 Enterprise weekly + daily microfilm**. The underlying 1926 ad is still unrecovered.
...
- Kwality Cafe
- New Kwality Cafe
- Larry's Kwality Cafe
- Quality Cafe wording from photo metadata
...
- `E-025` The Wheel at 503 Main, 1967 municipal record
- `E-044`–`E-049` newspaper evidence for later Wheel chronology
...
- Dick and Sheila later purchased the **505 real estate** from Mrs. Nesmeth / Nemeth (spelling uncertain)
...
- 505 building passed through Dick's estate to Rodney Young and Mitchell Young; current ownership/stewardship through 505 LLC
...
Primary file: `people/people-index.md`

High-priority people/entities:
...
## Steward uploads — 1907–1910 Fifth/Main Sawyer/Surber/Justin/Andresen/Mt. Hood reconciliation

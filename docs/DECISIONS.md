...
| D-005 | 2026-08-16 | Mitch / Mitchell (C.) Young **ran** 505 Tavern 1991-2004; do not claim he restored a name, fixtures, or the building. **Mitch Young, Mitchell Young, Mitch C. Young, and Mitchell C. Young are the same person** (`P-011` = `P-018`). | Family correction of earlier "restored/operated" wording. | `E-004`; `E-022` |

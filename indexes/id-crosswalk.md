...
| --- | --- | --- |
| `B-001` 503 Main Street | `BUS-001` Kwality Cafe; `BUS-004` The Wheel / Wheel Cafe at **503 only** | `E-001`, `E-002`, `E-003`, `E-020`, `E-021`, `E-022`, `E-025`, `E-042`–`E-045`, `E-047`–`E-049`, `E-094`, `E-095`; `S-024`-`S-028`, `S-048`–`S-052`, `S-054`–`S-058`, `S-107`–`S-110`. **Do not attach `E-038` to 503; the former Mrs. Nemeth/Nesmeth 503 purchase claim is superseded.** `E-095` is an archival retrieval lead, not proof of 503 title. |
| `B-002` 505 Main Street | `BUS-005` 505 Tavern; `BUS-006` Thirsty Duck; `BUS-010` Brass Rail; `BUS-016` Dug Inn | `E-004`, `E-005`, `E-022`, `E-026`-`E-039`, `E-041`, `E-045`, `E-046`, `E-094`, `E-095`; `S-028`, `S-032`-`S-043`, `S-048`, `S-052`, `S-053`, `S-107`–`S-110`. `E-038` records the corrected Wiitanen purchase of the **505 building** from Mrs. Nesmeth/Nemeth after they had already begun operating Brass Rail. `E-095` is an archival retrieval lead, not proof of 505 title. |

...
| `B-005` 501 Main Street (historic / removed) | `BUS-024` Palace Saloon (1912); `BUS-025` Hunsaker & Taylor liquor premises (1913); 1925 store occupant unknown | `E-020`, `E-021`, `E-054`–`E-056`, `E-094`, `E-096`, `E-097`, `E-103`, `E-104`; `S-021`, `S-023`, `S-064`–`S-069`, `S-107`, `S-108`, `S-111`–`S-113`, `S-117`–`S-119`. The 1912/1913 notices do not prove a transfer or continuity. Gates's corner site may map principally to 501 or include 503; 501 remains live until the July restaurant address is proved. |

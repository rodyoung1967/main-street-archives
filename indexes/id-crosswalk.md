...
| `B-002` 505 Main Street | `BUS-005` 505 Tavern; `BUS-006` Thirsty Duck; `BUS-010` Brass Rail; `BUS-016` Dug Inn | `E-004`, `E-005`, `E-022`, `E-026`-`E-039`, `E-041`, `E-045`, `E-046`, `E-094`–`E-100`; `S-028`, `S-032`-`S-043`, `S-048`, `S-052`, `S-053`, `S-107`–`S-116`. `E-038` records the corrected Wiitanen purchase of the **505 building** from Mrs. Nesmeth/Nemeth after they had already begun operating Brass Rail. `E-100`/`S-116` corroborate **1940** construction date from 2009 resurvey. Interval pass: `evidence/source-captures/1973-1987-503-505-research-pass.md`. |

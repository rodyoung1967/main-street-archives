...
| `B-005` 501 Main Street (historic / removed) | 1925 store occupant unknown; Holman Fifth/Main hypothesis remains unnumbered | `E-020`, `E-021`, `E-054`–`E-056`, `E-094`, `E-096`, `E-097`, `E-103`; `S-021`, `S-023`, `S-064`–`S-069`, `S-107`, `S-108`, `S-111`–`S-113`, `S-117`. Gates's corner site may map principally to 501 or include 503; 501 remains live until the July restaurant address is proved. |

...
| --- | --- | --- |
| `B-001` 503 Main Street | `BUS-001` Kwality Cafe; `BUS-004` The Wheel / Wheel Cafe at **503 only** | `E-001`, `E-002`, `E-003`, `E-020`, `E-021`, `E-022`, `E-025`, `E-042`–`E-045`, `E-047`–`E-049`, `E-094`–`E-099`; `S-024`-`S-028`, `S-048`–`S-052`, `S-054`–`S-058`, `S-107`–`S-115`. **Do not attach `E-038` to 503; the former Mrs. Nemeth/Nesmeth 503 purchase claim is superseded.** `E-095` is an archival lead; `E-096`–`E-097` leave 503's Gates/Wolf assignment unresolved. |
| `B-002` 505 Main Street | `BUS-005` 505 Tavern; `BUS-006` Thirsty Duck; `BUS-010` Brass Rail; `BUS-016` Dug Inn | `E-004`, `E-005`, `E-022`, `E-026`-`E-039`, `E-041`, `E-045`, `E-046`, `E-094`–`E-101`; `S-028`, `S-032`-`S-043`, `S-048`, `S-052`, `S-053`, `S-107`–`S-116`. `E-038` records the corrected Wiitanen purchase of the **505 building** from Mrs. Nesmeth/Nemeth after they had already begun operating Brass Rail. `E-100`/`S-116` corroborate **1940** inventory date from 2009 resurvey; **`E-101`** holds unresolved rear-expansion hypothesis for that date. Interval pass: `evidence/source-captures/1973-1987-503-505-research-pass.md`. Rear/1940 hypothesis: `evidence/source-captures/505-rear-expansion-1940-date-hypothesis.md`. |
| `B-003` 507-511 Main Street / Harding Building | `BUS-007` Harding Drug Store; `BUS-008` Tony's Restaurant; `BUS-023` Dixon's Bakery fire context | Original-building evidence `E-016`, `E-017`, `E-020`, `E-021`, `E-045`, `E-094`; OHS retrieval lead `E-095`; `S-052`, `S-107`–`S-110`. Present replacement building dated **1968** by `S-063`. |
...
| `B-005` 501 Main Street (historic / removed) | 1925 store occupant unknown; Holman Fifth/Main hypothesis remains unnumbered | `E-020`, `E-021`, `E-054`–`E-056`, `E-094`, `E-096`, `E-097`; `S-021`, `S-023`, `S-064`–`S-069`, `S-107`, `S-108`, `S-111`–`S-113`. Gates's corner site may map principally to 501 or include 503; 501 remains live until the July restaurant address is proved. |
...
| `P-035` S. Wolf of Portland | `E-096`; 20 Jul. 1922 fire report; `B-001`, `B-002`, `B-005` unresolved | Reported buyer of Harding's remainder and owner of the ignition building. Full identity, deed, and exact modern storefront unresolved; do not merge with other Wolf people/businesses. |

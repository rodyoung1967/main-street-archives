...
- Type: Photo metadata / uploaded Time Capsule Maps record
- Related buildings: 503 Main Street and 505 Main Street
- Evidence: `E-015`
- Source: `S-010`
- Status: Referenced from Time Capsule Maps metadata; original photo source unknown.
...
- Confidence: Useful as project metadata and location/context note; needs original photo source, date, and visual verification before being treated as primary evidence.
...
- Source: `S-010`
- Status: Published in Time Capsule Maps metadata; original source unknown.
...
- Confidence: Good project metadata; original source/date still need confirmation.

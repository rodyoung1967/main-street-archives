...
- **1916–17 Book 4:** sequence **511 → 509 → 507 → 503 → 503½ → 501**, with no separately written 505 Main account. The 503½ tenant entry is compatible with the Book 3 **Fred Steiner** reading. The 503 tenant's leading steward reading is **Charles Schoenheinz**, still probable/working rather than documented exact-address fact. At **501 Main**, surname **Pollock** is a strong visual reading, initials remain unclear, and a diagonal annotation reads **Fifth Street Restaurant / 5th St Restaurant** with high confidence.

...
Most importantly, on **25 August 1908** *The Oregonian* identified merchant **Henry Brightbill's store at 503 Main Street** (`E-042` / `S-049`). The former earliest-target ranking is superseded by Surber's **4 October 1907 No.501** notice (E-121); this remains direct dated evidence for **503**. It proves that **503 Main was an active address/storefront in 1908**, but it does **not** prove that the surviving building later dated about 1919 was already standing.

On **18 September 1908**, separate applications name **Justin & Hitchman** and **A. J. Surber** at Fifth/Main, while Thomas Hartman is on Main between Fifth/Sixth (E-122/E-123/S-137). The notices do not print 501 or prove succession. Targeted searches did not recover a 1908 occupant explicitly at **501, 505, or 507 Main**, and no direct 1908 report was found showing demolition, moving, replacement, new construction, or a fire securely tied to the target odd-side predecessor buildings. Those are research-status findings, not evidence of vacancy or no construction.
...
The Smith evidence gives 503 a clear early-1912 business sequence. The January advertisement names **H. N. Smith** at 503 Main; on 24 March a legal notice signed **H. H. Smith** applied for a pool-hall license at his place of business, **503 Main Street**; and in July H. H. Smith was reported leaving Oregon City after conducting a pool hall at **Fifth and Main** (`E-089`). The chronological and business overlap is strong, but the H. N. / H. H. initials discrepancy is preserved rather than silently merged (`RL-037`). The Fifth/Main wording supports a close geographic relationship for the 503 premises but is not treated as conclusive corner/lot mapping without the numbering plat or comparable evidence.

At the north end of the block, a 24 March report places the **Gambrinus Saloon at Sixth & Main** and names **William Trudell** as proprietor (`E-091`). This extends the Gambrinus chronology from the 1906 William Tell property sale, through 1910 new-block construction and 1911 Electric Hotel annex occupancy, into an active 1912 saloon use. The report still gives no exact numbered storefront and does not close the William Tell demolition-link question (`RL-031`).

A particularly important 10 May *Courier* editorial states in the present tense that Oregon City was **tearing down buildings on Main Street and building new ones in their places** (`E-090`). This confirms 1912 as an active Main Street structural-replacement year. However, the item names no block, owner, business, or address, and targeted follow-up did not securely tie the work to 501/503/505/507. It is therefore recorded as citywide Main Street demolition/rebuilding evidence—not as proof that the target predecessor buildings were replaced in 1912 (`RL-038`).

By December, **Herman Schrader** (`P-096`) sold his two Oregon City bakeries, including one on Main Street, to **Wemmo & Haas** (`P-097`; `BUS-063`, `BUS-080`, `E-093`). January advertising had described Schrader's Bakery as near the Post Office, but no exact Main Street number is recovered, so the sale remains a business-transition/relative-location record rather than a numbered-address or property-transfer claim.

For exact target status in 1912: **501 is directly occupied by Joe Wilson's Palace Saloon, 503 by the Smith pool-room/pool-hall use, and 507 by G. H. Young; 505 remains unresolved in exact-number evidence.** Brightbill is at 509 and Harding's own business at 511. No fire was recovered securely tied to 501, 503, 505 or 507. Remaining inaccessible *Courier* page-image coverage is logged under `RL-036`. Exact 1912 address use proves predecessor storefront occupancy, not that the surviving later-dated 503/505 buildings were already standing.

## October 1913 — 501 Main, numbering-plan lead, and Block 4 / Block 26 owner snapshot
The visually reviewed 3 October *Morning Enterprise* directly identifies **Hunsaker & Taylor at 501 Main Street** in a liquor-license application (`E-104` / `S-119`). A City Recorder notice in the same issue says the official street-numbering **plat and plan** remained on file and quotes **Ordinance No. 357** (`E-105`), strengthening the retrieval route for the original address map without itself mapping 501/503/505 to original Block 4 lots.
...
### 1916 — CCHS MOT:P-502 G. H. Young / W. W. Bradley 507 Main conflict
...
## The Wheel at 503 — ownership sequence
The current family-confirmed working sequence is:

1. **Raye owned The Wheel business.**
2. **Dick and Sheila Wiitanen purchased The Wheel business from Raye.**
3. **Later, Dick and Sheila purchased the 503 Main building itself.** The exact seller/date remain open.
4. By August 1985, Richard M. Wiitanen is independently documented as owner of **The Wheel Cafe business** at 503 (`E-049`).
5. **When Dick and Sheila later sold The Wheel business, they also sold the 503 building.** Exact buyer/date/deed/business-sale and liquor-transfer records remain open.

This replaces the earlier archive uncertainty that treated Wiitanen ownership of the 503 real estate as unconfirmed. It also keeps the 503 sequence separate from the Mrs. Nesmeth/Nemeth property purchase, which belongs to **505 Main**.

**"The Wheel Tavern" was never an official name.**

## 505 Tavern / Ray Hansen
Ray Hansen belongs to the separate 505 business chain and is not Raye Grisham.

## Dick and Sheila run Brass Rail before owning 505
Family history establishes that Dick and Sheila ran Brass Rail at 505 Main before they owned the 505 building.
...
- **1914–15 Book 3:** 503 Main is separately numbered/classified **Store**; 503½ is separately numbered/classified **Barber Shop**; **G. A. Harding, Agt.** repeats as owner/agent. High-resolution steward rereview reads the 503½ tenant as **Fred Steiner** with confidence. The 503 tenant has a new leading steward handwriting reading: **C. Schoenheinz**, a high-confidence steward reading / probable transcription. Identity as **Charles Schoenheinz** is a separate **PROBABLE / WORKING HYPOTHESIS** pending an independent bridge; the earlier C. Schoenheinz shoe-shop evidence makes a shoe-store interpretation interesting but does not prove the 503 store was a shoe store. Contemporary 1916–17 newspapers establish Charles in Oregon City and with an interest in the Theroux music store, but Theroux is independently advertised at 519 Main, so that business evidence does not prove 503. At 501, faint tenant/business wording appears to end in **Cafe**, first word unresolved.
...
- **1916–17 Book 4:** sequence **511 → 509 → 507 → 503 → 503½ → 501**, with no separately written 505 Main account. The 503½ tenant entry is compatible with the Book 3 **Fred Steiner** reading. The 503 tenant's leading steward reading is **C. Schoenheinz**. Charles Schoenheinz is the leading identity hypothesis, not part of the ledger transcription; possible shoe-store use remains unproven. At **501 Main**, surname **Pollock** is a strong visual reading, initials remain unclear, and a diagonal annotation reads **Fifth Street Restaurant / 5th St Restaurant** with high confidence.

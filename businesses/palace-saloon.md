...
Business ID: `BUS-024`. Exact numbered address is directly proved at **501 Main Street (`B-005`) in March 1912**. Earlier evidence now establishes a reported 1900 Knapp purchase, a 1905 Knapp→Surber Palace sale, and a July 1907 Fifth Street location clue without a numbered storefront.

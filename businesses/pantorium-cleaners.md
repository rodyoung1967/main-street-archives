# Oregon City Pantorium / Pantorium Cleaners

Business ID: `BUS-073`. Person: `P-093`.
...
A same-day Eugene fire report says a cleaning-and-dyeing establishment had vacated the July ignition room only days earlier. Pantorium is a legitimate candidate to test, but no source proves its 17 July 1922 location. Do not identify it as the ignition-room tenant or claim that it moved because of the fire.

Full chronology: [Pantorium address reconstruction](../evidence/source-captures/pantorium-cleaners-address-chronology-1914-1922.md).

# Farr Brothers Store / Meat Market

Business ID: `BUS-104`. Official identity context includes Clarence P. Farr (`P-395`); the May 1917 article itself names no individual proprietor.

## Chronology

- **25 May 1917:** *Oregon City Enterprise* directly calls **Farr Brothers** a **Meat market** (`E-253` / `S-280`); no address printed.
...
## July 1919 market-report continuation

# Price Bros. clothing store

- Business ID: `BUS-028`
- Reported proprietor: **Al Price**, `P-043`; do not expand the given name or merge with other Price people.
- Dated address: **527 Main**, 5 August 1915; `B-004` address history, not the later 1935 structure.
- Evidence/source: `E-107` / `S-120`; media `IMG-0058`, `IMG-0060`.

The 5 August 1915 *Courier* page 3 directory advertises Price Bros. at 527 Main, phone 107. Its establishment-year claim of 1895 does not establish occupancy at 527 since that year. Earlier Sixth/Main advertisements (`E-081`) supply intersection context only; the 1915 exact number is not backdated.

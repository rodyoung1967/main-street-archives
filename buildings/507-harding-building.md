...
- Related evidence: `E-016`, `E-017`, `E-020`, `E-021`, `E-045`, `E-085`, `E-092`, `E-094`, `E-095`, `E-107`, `E-108`, `E-109`, `E-116`, `E-119`, `E-128`, `E-129`, `E-130`, `E-131`
...
The original/taller Harding Building burned in a Main Street fire the night of **1 September 1967**, reported in the Oregonian of 2 September 1967 (`E-045` / `S-052` / `IMG-0047`). Harding Drug Store was among the businesses gutted. Dixon's Bakery was also gutted. The Oregonian names the reported origin as a two-story furniture warehouse owned by Howard Cohn. **The Wheel Restaurant and the 505 Tavern were the only establishments in the reported fire block spared by flames**, with smoke and water damage.

Earlier working dates of late 1968 or 1969 (`E-016`) are superseded for the **fire date**. The replacement-building year is now supported at the historic-inventory level: ODOT's 2021 cultural-resources report lists **507-511 Main St — Harding Building — 1968** (`S-063`). Primary permits, assessor records, plans, and construction notices remain desirable for the exact construction sequence and completion date.
...
Official secondary evidence (`S-063`): ODOT's 12 May 2021 cultural-resources report, p. 16 Table 2, lists **507-511 Main St — Harding Building — 1968**. This resolves the former 1968-versus-1969 replacement-year question at the historic-inventory level.

Still needed are the primary project records: demolition/fire cleanup permits, building permit, plans, architect/builder, assessor change, exact completion/occupancy date, and evidence showing how the pre-fire 507/509/511 storefront parcels were combined in the replacement.

Related research lead:

- `RL-004` - Harding Building Fire (now focused on replacement-project details, Tony's Restaurant, storefront consolidation, and fire-department/insurance corroboration)
...
- [527 Main / Swartz Building](527-swartz-building.md)
...
- Evidence showing exactly which old storefront parcels/addresses were consolidated into 507-511.
- Tenant evidence for Tony's Restaurant and exact 1967 Dixon's Bakery storefront address.
...
- Search assessor records for the 1967-1968 replacement and value/footprint change.

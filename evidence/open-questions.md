...
This register collects unresolved questions across the Main Street Archive. Questions should stay open until linked evidence answers them.
...
**1926 report continuation, also relevant to OQ-001/OQ-005:** `E-142` / `S-159` distinguishes a Fifth/Main **false alarm** from a separate Sixth/Main damage entry. Neither is assigned to 501/503/505; no target construction date or occupant was recovered. `E-143` adds a contemporary county-labeled health payment and inspection/receipt retrieval leads, not a custody determination. [Full review and next records](source-captures/1926-municipal-report-visual-review-2026-09-01.md).

When was the current 505 Main Street building constructed?

Status: **Unresolved.** Official inventories give **c.1920** (`E-032` / `S-033`) and **1940** (`E-100` / `S-116`, `S-063`), while **1925 Sanborn** and **1936 aerial** evidence show a 505-address structure before 1940. A working but unproven hypothesis (`E-101`) holds that **1940** may reflect rear expansion or major rear remodel while **c.1920** may better describe the Main Street front / historic core. **`E-102`** (August 2026) visually verified **1925 vs. 1950** Sanborn continuity at 505 with **CONC. FL.** by 1950 and block-level reconfiguration, strengthening mid-century improvement plausibility but **not** confirming a 505-specific rear extension ~1940. No **1939–1941** permit recovered. The **5 September 2026 address-level aerial re-review is now complete** (`E-102`): 1940 is the earliest reviewed frame with distinguishable deeper-505 rear depth relative to 503, but it is a by-1940 state rather than a construction date. Assessor cards, permits, and physical analysis are still needed.
...
**20 September 2026 hypothesis refinement:** the June 1920 Leland anchor now raises a specific structure/occupancy question: **if the surviving 505 building was in fact newly constructed or materially reconfigured around 1920, was A. Leland an initial or first commercial occupant?** This is a **PROBABLE / WORKING HYPOTHESIS only**, not a timeline fact. Wolf & Miller is directly documented at the 505 address in October 1918, while `E-135` / `S-150` directly places A. Leland's pool-hall/sign approval at **505½ Main** on 2/4 June 1920. No recovered source yet says “new building,” “new quarters,” “first tenant,” identifies a lease/landlord, or proves that the 1918 and 1920 occupancy anchors concern different physical buildings. Resolve with the underlying 2 June Commission record/application, 1919–1921 assessment/improvement records, 1919–1920 Polk directory, permit/lease records, and contemporary opening/move notices. Absence of an earlier recovered occupant is not first-tenancy proof.
...
Status: Location answered; exact name sequence partly open.
...
Status: Major roles clarified; exact transaction records remain open.
...
Status: Family sequence substantially clarified; documentary dates remain open.

**Raye LaFarlette and Raye Grisham are the same person.**
...
What source, if any, places Dr. Bailey's dental practice upstairs in the Harding Building in 1909? The statement existed in the archive without a linked source. The Museum of the Oregon Territory reference spreadsheet for `MOT:P-391` identifies a Dr. Bailey among the four men in the institutionally dated 1910 G. H. Young storefront photograph, now preserved as `IMG-0725`; that identification does not establish an office location or a 1909 Harding Building tenancy. Search 1908–1911 directories, dental/professional advertisements, and building tenant notices. Do not cite the Harding Building occupancy as established until directly supported.
...
The [28 August 2026 Tasks 5–6 identity audit](source-captures/1922-tasks-5-6-identity-review-2026-08-28.md) adds a direct Gilbert Miller firm association and verified candidate-source readings, but no buyer/full-name or property-boundary bridge. The subsequent [current-plan Task 7 model test](source-captures/1922-task-7-fire-origin-model-test-2026-08-28.md) is complete with an unresolved result: neither model is selected or shown superior, both require an unproved Gates-to-501 correspondence, and neither exhausts possible arrangements. The post-fire footprint and actual ignition room need separate bridges. [Task 8 handoff](source-captures/1922-task-8-integration-handoff-2026-08-28.md) consolidates eight open manual callouts and unfinished online review. OQ-031 stays open; 1922 remains IN PROGRESS.

**13 September 2026 licensing-context update:** the complete January–February newspaper review (`E-346`) verifies that the 1922 ordinance required pool-room applications and published notices to identify the particular premises and barred unapproved license transfers. The reviewed pages do not name any hall or operator. This sharpens, but does not answer, the premises question: recover the location-specific petitions/notices/bonds and Council actions under `MF-013`; do not assign Timms, Leland & Little, A. Leland or the July fire-adjacent hall to 505 from the citywide ordinance.

`E-281` adds a negative identity discriminator, not a boundary answer: the local directory candidate is now controlled as **Victor John Wolf**, reported at Oregon City Route 6 on 26 June 1922, while the July buyer/fire owner is printed as **S. Wolf of Portland**. Do not merge them absent direct contrary evidence. The dividing line and S. Wolf's full identity remain open; deed/title/assessment evidence still has priority.
...
## 6 September 2026 — who controlled 503 at the Kwality/Flor → Wheel transition?
<!-- Flor Kwality Wheel 1957-1958 transition sync — 2026-09-06 -->

`E-032` / `S-026` places Mr./Mrs. Albert D. Flor with the 503 restaurant/cocktail bar in **1957**; `E-255` / `S-282` directly places **Wheel Cafe & Lounge at 503 Main** by **22 August 1958**. The exact transition is now narrowed but still unanswered.
...
- **Who was C. Schoenheinz at 503 Main?** Enlarged Book 4 handwriting is now read by the project steward with high confidence as **C. Schoenheinz**. Determine whether this was Charles Schoenheinz, whether he was the same C. Schoenheinz who operated the Old Reliable Oregon City Shoe Shop at 716 Main in 1911, and whether the generic 503 `Store` was a shoe store. All three identity/use links remain unresolved; Hylton and Schiermann are withdrawn handwriting readings.

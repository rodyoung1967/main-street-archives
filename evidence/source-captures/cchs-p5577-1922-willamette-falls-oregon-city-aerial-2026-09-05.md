# CCHS P-5577 — 1922 aerial view of Willamette Falls, West Linn and Oregon City

Reviewed **5 September 2026** from the project-steward supplied image and exact Clackamas County Historical Society CatalogIt object `P-5577`.

Archive IDs: source `S-241`; evidence `E-215`; media `IMG-0761`; timeline `T-089`.

## Institutional catalog metadata supplied by project steward

- Name/Title: **Oregon City 1922 - Aerial View of Willamette Falls and Oregon City**
- Entry/Object ID: **P-5577**
...
- Public API: https://api.catalogit.app/api/public/accounts/4813/entries/a7942480-9b1e-11eb-b3ef-53e7205a00b4

## Repository image

- File: `media/photos/aerials/IMG-0761_1922-willamette-falls-oregon-city-aerial-cchs-p5577.jpg`
- Source: largest public CCHS derivative recovered from the exact `P-5577` object
- Dimensions: **2400 × 1875**
- Bytes: **695,334**
- SHA-256: `ecb09a7f1f8b1631d6727fb010304ccde5a2c2d938661f415935b80219d31e6c`

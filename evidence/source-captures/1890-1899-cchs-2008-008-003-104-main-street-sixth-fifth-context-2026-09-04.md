# CCHS 2008.008.003.104 — Main Street, Oregon City, cataloged 1890–1899
...
Archive IDs: source `S-214`; evidence `E-194`; image `IMG-0743`; timeline `T-077`. Related fixed-location comparison: `S-204` / `E-184` / `IMG-0733` (CCHS P-1456, 1890 Sixth/Main looking south after flood). Related map context: `SM-005` / `S-018` / `E-020` (1892 Sanborn) and `SM-006` / `S-019` / `E-020` (1900 Sanborn).

## Catalog record

- Institutional title: **Main Street, Oregon City**
- Entry/Object ID: `2008.008.003.104`
...
- Public record: https://hub.catalogit.app/clackamas-county-historical-society/folder/photographs/entry/main-street-oregon-city-5
- Public API entry: https://api.catalogit.app/api/public/accounts/4813/entries/a4d46840-9b1e-11eb-b3ef-53e7205a00b4

## Steward attachment

- Original filename: `Main Street, Oregon City looking south from 6th onto 5th st.jpg`
- Dimensions: **2048 × 1420**
- Bytes: **527,507**
- SHA-256: `69de483d0541125560cbdd263435aa0a69847975c0aacff8a90f732e220605a0`
- Steward viewpoint note: **The project-steward supplied filename identifies the scene as looking south from Sixth Street toward Fifth Street on Main Street. This wording is preserved as steward metadata, not as CCHS catalog text.**

## Repository image

- File: `media/photos/early-main-street/IMG-0743_1890-1899-main-street-oregon-city-cchs-2008-008-003-104.jpg`
- Public derivative recovered from the exact CCHS record: https://d8e7jbdw4fu0e.cloudfront.net/4813/a32e7440-9b7d-11eb-97c3-a30f15c9573f-vdUe7X7.lg@2x.jpg
- Dimensions: **2399 × 1664**
- Bytes: **454,590**
- SHA-256: `853afd9db056375c724ad35599a772836a9d3732bf313dc22048e939124fab49`
...
The project-steward supplied filename says the view looks **south from Sixth toward Fifth Street**. That wording is not present in the CCHS catalog metadata for `2008.008.003.104` and is therefore preserved as **project-steward metadata** rather than institutional description.

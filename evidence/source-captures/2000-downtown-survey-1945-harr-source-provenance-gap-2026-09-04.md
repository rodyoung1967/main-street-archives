# 2000 Downtown Oregon City survey — source-provenance gap behind 1945 Harr chronology
...
- Clackamas County Historical Society and Museum — history files and historic photographs;
- *Oregon City Enterprise* newspapers;
...
- Sanborn Fire Insurance Maps for Oregon City, 1892, 1911, and 1925;
- Sohns & Woodbeck, *Clackamas County and Oregon City Directory*, 1917.
...
The same official report's Appendix A, visually inspected from the original PDF, lists **505 Main Street** with historic name **Unknown** and construction date **c.1920**. That summary table does not identify Farr's Pool Hall, Harr's Recreation Center, or a 1945 occupant.

The repository's separate registered City 505 resource page (`S-033` / `E-032`) remains the source carrying the official-secondary **1945 Harr's Recreation Center at 505** chronology statement.

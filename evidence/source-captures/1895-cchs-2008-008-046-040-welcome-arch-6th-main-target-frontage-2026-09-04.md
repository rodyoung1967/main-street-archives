# CCHS 2008.008.046.040 — Oregon City "Welcome Arch", 6th and Main, 1895
...
Archive IDs: source `S-215`; evidence `E-195`; image `IMG-0744`; timeline `T-078`. Related later-address records: `B-005` (501), `B-001` (503), `B-002` (505). Related fixed-location comparison: `S-204` / `E-184` / `IMG-0733`. Related map context: `SM-005` / `S-018` / `E-020` (1892 Sanborn).

## Catalog record

- Institutional title: **Oregon City "Welcome Arch"**
- Entry/Object ID: `2008.008.046.040`
...
- Other No.: **Culp, Ed 40**
- Stevens Photo #: **97**
- Public record: https://hub.catalogit.app/clackamas-county-historical-society/folder/photographs/entry/oregon-city-welcome-arch-1
- Public API entry: https://api.catalogit.app/api/public/accounts/4813/entries/8ff53cb0-9b1e-11eb-b3ef-53e7205a00b4

## Steward attachment

- Original filename: `Welcome Arch, O.C. Main St., 1895.jpg`
- Dimensions: **2048 × 1285**
- Bytes: **886,058**
- SHA-256: `90a533ef0c721ed65ed45d090d07ac0dcc372cba0f8d138543f96a2b7035924e`
- Steward target annotation: **Project steward identifies the predecessor Main Street frontage later numbered 501, 503 and 505 as visible in the background on the right side of the street.**

## Repository image

- File: `media/photos/early-main-street/IMG-0744_1895-oregon-city-welcome-arch-6th-main-cchs-2008-008-046-040.jpg`
- Public derivative recovered from exact CCHS record: https://d8e7jbdw4fu0e.cloudfront.net/4813/cd1949b0-9b69-11eb-97c3-a30f15c9573f-vdUe2pl.lg@2x.jpg
- Dimensions: **2400 × 1506**
- Bytes: **798,714**
- SHA-256: `6f35359b9de3509a64ebec65d810b38b1048092eaeb3fcb6161d5d048e65603f`

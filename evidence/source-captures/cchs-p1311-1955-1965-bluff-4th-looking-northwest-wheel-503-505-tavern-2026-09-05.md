# CCHS P-1311 — bluff at 4th Street looking northwest, 1955–1965

Reviewed **5 September 2026** from the project-steward supplied photograph and the exact Clackamas County Historical Society public CatalogIt object `P-1311`.

Archive IDs: source `S-232`; evidence `E-206`; media `IMG-0753`; timeline `T-085`. Related buildings/businesses: `B-001` / `BUS-004` (503 Main / The Wheel) and `B-002` / `BUS-005` (505 Main / 505 Tavern).

## Institutional catalog metadata supplied by project steward

- Name/Title: **Oregon City 1955 - from the Bluff at 4th Street Looking Northwest**
- Entry/Object ID: **P-1311**
...
- Public API: https://api.catalogit.app/api/public/accounts/4813/entries/02f1e1f0-9b1f-11eb-b3ef-53e7205a00b4
...
- Original filename: `Oregon City 1955 - from the Bluff at 4th Street Looking Northwest.jpg`
- Dimensions: **2048 × 1616**
- Bytes: **909,725**
- SHA-256: `e04639c56001073eed1c010708298ca50460e0380b8e004509732328696bde98`
- Steward visual note: **Project steward identifies THE WHEEL wording on the 503 Main frontage and 505 TAVERN wording/signage on the 505 Main frontage.**

## Repository image

- File: `media/photos/main-street/IMG-0753_1955-1965-bluff-4th-looking-northwest-wheel-503-505-tavern-cchs-p1311.jpg`
- Source: largest public CCHS derivative recovered from exact catalog object `P-1311`
- Dimensions: **2400 × 1894**
- Bytes: **789,479**
- SHA-256: `9ebb56e79da912ab2ad8649bf3f2f0d07f124eca2fc264923213585c512c4599`
...
- **DOCUMENTED / DIRECT (institutional catalog):** CCHS object `P-1311`, title, description, and **1955–1965** Date made range.

...
The City of Oregon City's **Downtown Oregon City Historic Resource Survey — Final Report (2000)** selected bibliography identifies:
...
> **1941 Oregon City directory, 181.**

Official Oregon SHPO nomination:

`https://www.oregon.gov/oprd/OH/Documents/SG100011430.pdf`

The final nomination's searchable official text therefore establishes **page 181** as a known useful page inside a 1941 Oregon City directory consulted by the nomination researcher.

This page locator does **not** identify Farr, Harr, 505 Main or 505½ Main, and the footnote itself does not name the publisher. It should be used as a retrieval/navigation aid, not as an occupant claim.
...
> **“Oregon City, West Linn, and Gladstone,” [1941], 112.**
...
Elsewhere in the final McLean nomination, footnote **102** says that physicians and surgeons participating in the Physicians Association of Clackamas County were listed in an **“R. L. Polk directory, 1941.”**

Independent FamilySearch catalog evidence confirms that a separate **1941 _Polk's Portland (Oregon) city directory_**, published by **R. L. Polk & Co.**, exists on microfilm. FamilySearch subjects it to **Portland / Multnomah County**, not Oregon City / Clackamas County.

FamilySearch catalog:

`https://libcat.familysearch.org/Record/34186/Home`

Therefore the McLean nomination's use of an R. L. Polk directory in one footnote does **not** require changing the independently documented publisher of the 1941 Oregon City directory from Pacific Directory Service to R. L. Polk. The nomination demonstrably draws on multiple directory sources.

Evidence boundary: the present pass does not prove that footnote 102 specifically used the FamilySearch-cataloged physical copy; it only confirms that a distinct 1941 Portland Polk directory exists and removes the need to merge the Polk citation into the Oregon City directory identity.
...
6. Carl R. Harr / Harr's Recreation Center;
7. Harris E. McDougald / Pastime Pool Hall;
8. Dr. Roy Briggs;
9. 505 Main / 505½ Main;
...
- `evidence/source-captures/1941-oregon-city-west-linn-gladstone-telephone-directory-farr-505-access-lead-2026-09-04.md`
- `evidence/source-captures/clackamas-local-directory-holdings-request-route-2026-09-04.md`

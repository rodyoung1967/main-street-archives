# CCHS P-1043 — 1930s Main Street from Sixth toward Fifth, business-sign roster

Reviewed **5 September 2026** from the project-steward supplied photograph and the exact Clackamas County Historical Society CatalogIt object `P-1043`.

Archive IDs: source `S-237`; evidence `E-211`; media `IMG-0758`; timeline `T-088`.

## Institutional catalog metadata supplied by project steward

- Name/Title: **Oregon City 1930s - Streetcar on Main at 6th**
- Entry/Object ID: **P-1043**
...
- Original filename: `Oregon City 1930s - Streetcar on Main at 6th(1).jpg`
- Dimensions: **2048 × 1214**
- Bytes: **617,696**
- SHA-256: `870d294ee08012121c057d63b6f90112ff5305600c36a2f1895fa57738b65e08`
...
`P-1043` is valuable **spatial context**, but it is not being used as another direct Farr-at-505 source. The stronger 1936 anchor remains CCHS `P-1128` (`S-236` / `E-210` / `IMG-0757` / `T-087`), where the 505 storefront is specifically mapped and the principal sign is probably `FARR'S`.
...
- **DOCUMENTED / DIRECT:** CCHS `P-1043`; catalog date range **1930–1939**; catalog view from Sixth looking southwest; streetcar and Main Street commercial corridor; readable signs listed above.

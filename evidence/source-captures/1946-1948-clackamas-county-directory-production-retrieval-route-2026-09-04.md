# 1946–1948 Clackamas County Directory production and retrieval route

Reviewed **4 September 2026** while continuing the Farr's Pool Hall → Harr's Recreation Center / 505 Main transition search.

Archive IDs: production evidence `E-201` from `S-221` / `S-222`; publication/retrieval evidence `E-202` from `S-223` / `S-224` / `S-225` / `S-226` / `S-227` / `S-228`.
...
Source: *Sandy Post*, 1 August 1946, p.3 (`S-221`).
...
Source: *Sandy Post*, 5 September 1946, p.4 (`S-222`).
...
Source: Oregon City Commission minutes / March 3, 1948 February-claims report (`S-223`).
...
Source: *Sandy Post*, 8 July 1948, p.5 (`S-224`).
...
Clackamas County Historical Society published a 2012 Oregon City fact sheet explicitly credited to **“Pacific Directory, 1947-48”** (`S-225`).
...
Oregon City's 2000 Downtown Final Report bibliography (`S-226`) cites:
...
A 2014 City of Lake Oswego historic-resource survey (`S-227`) cites:

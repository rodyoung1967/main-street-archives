# 1918 → 1925 target-frontage photographic / map structural bracket
...
Related new sources: `S-311` / `E-283` / `IMG-0769` and `S-312` / `E-284` / `IMG-0770`. Existing map control: `E-020` / `S-021` (1925 Sanborn) and the 1911→1925 geometry reconciliation associated with `E-272`.

...
The official high-resolution **1914–1915 Water Rent Record Book 3** was revisited specifically to finish the target/Fifth-Main questions left open by the earlier screenshot review. Reviewed source extracts are preserved under `records/municipal/water-rent/1914-1915-book-3-review-pages/`; the detailed audit is [here](1914-1915-water-rent-record-book-3-visual-review.md) (`S-131` / `E-117`).
...
| Fifth between Main and Water | W. S. Eddy / Fashion Stable | Direct newspaper relative-location evidence; no street number printed and no automatic equation to 110 Fifth |

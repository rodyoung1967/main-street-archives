...
Date: Confirmed March 1991-March 2004; naming clarification received 24 August 2026  
Claims: Mitch Young / Mitchell Young / Mitch C. Young / Mitchell C. Young are the same person (`P-011` / `P-018`). He **ran** (owned and operated) **505 Tavern** at 505 Main Street from March 1991 to March 2004. Mitch's further direct statement, relayed by Rodney Young, says that after Dick and Sheila Wiitanen repossessed the business, **the Wiitanens renamed it 505 Tavern before selling it to their son Mitch**. Mitch therefore acquired the business under that already-existing public/trade name; he did not introduce or restore the name. The exact rename date and formal OLCC/license/entity wording remain open. This period is not The Wheel.  
Confidence: Very High for ownership/operation dates, 505 Main location, and public/trade name at acquisition; High for the pre-sale Wiitanen rename as participant/family testimony, pending documentary records for exact date and legal mechanics.
...
Claims: Mitch Young's March 1991-March 2004 period belongs to **505 Tavern at 505 Main Street**, not The Wheel. Direct participant testimony establishes that Dick and Sheila Wiitanen renamed the business 505 Tavern before selling it to their son Mitch, so the name predates his acquisition. `BUS-009` The 505 remains as an earlier handling label. **The Wheel was only at 503 Main.**  
Confidence: High for the archive-handling rule and pre-acquisition public/trade name; license/entity records remain desirable for the exact rename date and legal wording.
...
Sources: `S-028`  
Claims: Family history places **Ray Hansen** before Dick and Sheila Wiitanen in the 505 Tavern business chain and says Dick and Sheila later operated the business as **Brass Rail Tavern**. The 19 August 2026 clarification (`E-022`, `E-038`) adds the crucial property sequence: **Dick and Sheila ran Brass Rail before they owned the 505 building**, then later purchased that building from Mrs. Nesmeth / Nemeth. After becoming landlords, the tavern business later passed through other owners/operators; later Wiitanen business-control periods may have involved repossession/default/transfer. Before the March 1991 sale to their son Mitch, the Wiitanens renamed the business 505 Tavern; exact rename date and formal license/entity wording remain open. `E-030` independently proves a Wiitanen-to-Cotterell change-of-ownership application in 1988. Exact sale/rename/property-purchase dates remain to be reconstructed from business-sale, license, deed, and repossession records.  
...
Sources: `S-026`, `S-033`, `S-062`  
Claims: City 503 record explicitly says little historic information was found, describes the building as apparently constructed circa 1919, and reports Kwality Restaurant 1926, Kwality Cafe 1947, and Flor 1957. It attributes Wolf-family ownership roughly 1922-1972 to research conducted during the 1983 survey. The c.1919 wording is therefore an approximate historic-survey conclusion, not primary construction proof, and the Wolf span is not deed proof from this page. Direct visual inspection of the official **2000 Downtown Final Report Appendix A** independently fixes the survey-table row alignment as **503 Main Street — c.1919 — Kwality Café — Commerce** and **505 Main Street — c.1920 — Unknown — Commerce**; Appendix B separately places both under **Historic but irretrievable loss of integrity** with those same names/dates. This visual control supersedes misleading row-shifted text extraction but does not upgrade the approximate construction dates to primary proof. City 505 record says the 1983 survey indicated c.1908, but explicitly concludes from Sanborn-map comparison that the surviving building was constructed sometime between 1911 and 1925, perhaps about 1920. It also reports no 1916 directory listing (not proof of vacancy), 1941 Dr. Roy Briggs at 505 1/2, 1945 "Harr's Recreation Center," and 1953 "Well's Recreation." The c.1908 survey date is therefore superseded within the City's own later synthesis; c.1920 remains tentative secondary interpretation, not primary construction proof. The **2009 Oregon Historic Site Form** (`S-116` / `E-100`) separately lists **505 Main** with **primary construction date 1940** and name line **505 Tavern**, corroborating the ODOT 1940 date (`S-063`) while leaving the c.1920 synthesis and 1925 Sanborn use in documented tension. Original directory pages and the individual 2000 503/505 forms remain desirable.  
Confidence: High for what the City survey pages and visually inspected 2000 Final Report tables report, including the exact Appendix A/B row alignment; Low-to-Moderate for treating c.1919 at 503 or c.1920 at 505 as literal construction years without primary construction records; underlying construction and title records remain preferable.
...
Claims: The 19 January 2009 resurvey form for **505 Main St** lists **primary construction date 1940** and current/other name **505 Tavern**. This corroborates the 2021 ODOT **1940** build-date line for 505 Main (`S-063`) but does not resolve the c.1920 city synthesis on `S-033` or the 1925 Sanborn billiards use. It names no Brass Rail, Hansen, or Wiitanen operators. See **`E-101`** for an unresolved working hypothesis that the 1940 line may reflect rear expansion or major rear remodel rather than first whole-building erection.  
Confidence: Very High for the form fields; High as 1940-date corroboration; Unresolved for rebuild/fabric meaning.

## E-101 — 505 Main Rear Expansion / 1940 Inventory-Date Working Hypothesis
Type: Working hypothesis / interpretive synthesis  
Sources: `E-010`, `E-011`, `E-020`, `E-021`, `E-032`, `E-100`, `S-033`, `S-063`, `S-116`  
Related record: `evidence/E-101-505-rear-expansion-1940-date-hypothesis.md`; source capture: `evidence/source-captures/505-rear-expansion-1940-date-hypothesis.md`  
...
## E-084 — Chicago Store Moves from 405 to 505 Main, 1911
Type: Primary newspaper advertising / exact-address business-relocation evidence  
Date: 27 January–28 April 1911  
Sources: `S-097`  
Related record: `evidence/E-084-1911-chicago-store-moves-405-to-505-main.md`  
Claims: The Chicago Store, explicitly **Wolf & Nat, proprietors**, advertised at **405 Main Street** through 3 February 1911. By 31 March it advertised at **505 Main St.**, repeated through April. The documented move/readdressing therefore occurred after 3 February and by 31 March 1911. The available 505 ad text does not directly name proprietors, so proprietorship continuity is not assumed. Exact 505 occupancy is not proof that the surviving later-dated 505 building was already standing.  
Confidence: Very High for the two addresses and relocation window; Unresolved for proprietorship immediately after the move and the physical relationship to the surviving 505 building.

## E-085 — Harding Building Location Ambiguity and Willamette Adjacency, 1911
Type: Primary newspaper / building-location and business-move evidence  
Date: 24 February–10 March 1911  
Sources: `S-098`  
Related record: `evidence/E-085-1911-harding-building-location-ambiguity.md`  
Claims: One *Courier* item locates a repair shop in the **Harding Building on Sixth Street between Main and Railroad Avenue**; another says George Young moved one door north into the **Willamette Building** from the **Harding Building on Main Street between Fifth and Sixth**. The evidence proves the one-door-north adjacency but does not establish exact street numbers or whether the two Harding descriptions refer to one physical building.  
Confidence: Very High for the published location descriptions and one-door-north move; Unresolved for exact number, lot/footprint, and relationship to later 505/507 numbering.

## E-086 — New Gambrinus Block Occupied as Electric Hotel Annex, 1911
Type: Primary newspaper / new-building occupancy evidence  
Date: 3 March 1911  
Sources: `S-099`  
Related record: `evidence/E-086-1911-gambrinus-block-electric-hotel-annex.md`  
Claims: J. Tobin, proprietor of the Electric Hotel, rented the **second story of the new Gambrinus block** as a hotel annex. The block was described as having steam heat, electric lights, and some rooms with hot/cold water connections. This establishes the 1910 new block as occupied/in service by early March 1911.  
Confidence: Very High for occupancy and described amenities; Unresolved for exact numbered address and the direct William Tell demolition/replacement link.

## E-087 — Sixth Street Grade and Improvement Across Main, 1911
Type: Primary newspaper reporting of municipal public works  
Date: March–October 1911  
Sources: `S-100`  
Related record: `evidence/E-087-1911-sixth-street-grade-improvement.md`  
Claims: Oregon City pursued a substantial Sixth Street grade/improvement process in 1911, including grade-change debate, assessment proceedings, and an assessment ordinance for improvement **from High to Jackson**. That corridor crosses Main at the north end of the target block. No source ties the work to demolition or replacement of a specific target storefront.  
Confidence: Very High for the Sixth Street improvement/grade process; Unresolved for effects on individual buildings.

## E-088 — Pacific Telephone & Telegraph at 510 Main, 1911 Continuity
...
## E-114 - 1915 Enterprise pages 161-200 visual review
Type: Primary newspaper visual review; source `S-128`.  
...
## E-190 — CCHS MOT:P-370 catalogs Young's Curio Store at 507 Main with 1907/1916 duplicate-date conflict
Type: Institutional photograph/catalog metadata plus direct visual review; **DOCUMENTED / VISUALLY VERIFIED** for storefront identity and **UNRESOLVED CONFLICT** for exposure date.
Source: `S-210`; image `IMG-0739`.
Claims: The supplied photograph visibly shows **NEW & SECONDHAND YOUNG'S CURIO STORE**. CCHS MOT:P-370 catalogs the scene at **507 Main Street, Oregon City** with structured date **1916**.
Conflict/limit: The same CCHS description says MOT:P-370 duplicates **MOT:P-6253** and that the same picture there has date **1907**. The reverse-side Ray O. Young stamp is catalog text, not visually verified because the reverse was not supplied. Do not use MOT:P-370 as unqualified 1916 occupancy evidence or as a building-continuity claim until the duplicate-date provenance is resolved.
Confidence: **Very High** for visible signage and catalog wording; **UNRESOLVED** for whether the exposure date is 1907, 1916, or reflects a copy/cataloging-date distinction.
...
## E-192 — CCHS catalogs 1890 Bank of Commerce interior at 512 Main
...
Source: `S-212`; image `IMG-0741`.  
Claims: CCHS object `2008.008.049.056` is cataloged **Interior of the Oregon City Bank of Commerce**, date **1890**, with description **“Interior of the Oregon City Bank of Commerce (1st National), 512 Main. Latourette and Myers ?”**. The supplied image visibly shows a historic bank/office interior with a long service counter and teller-style partitioning. Catalog metadata also gives **Negative**, **Society Collection**, **Lynch-Criteser 056**, and **Freytag Collection #1**.  
...
## E-193 — CCHS 1895 bluff photo shows pre-1922 Main/Fifth target-frontage roofline candidate
...
Source: `S-213`; image `IMG-0742`; timeline `T-076`; map context `SM-005` / `S-018` / `E-020`.  
Claims: CCHS object `2008.008.003.125` is cataloged **Lower Main Street Oregon City from Top of 3rd Street Stairs 1895**, described as Oregon City from the bluff looking downriver from the top of the 3rd Street Stairs. The image directly depicts the lower-Main commercial streetscape. The project steward identifies the roof/top of the predecessor frontage later associated with 501, 503 and 505 Main as visible; that identification is compatible with the developed commercial frontage independently mapped in 1892.  
...
## E-194 — CCHS 1890-1899 Main Street view provides pre-numbering Fifth-Sixth block streetscape context
...
Source: `S-214`; image `IMG-0743`; timeline `T-077`; comparison `S-204` / `E-184`; map context `SM-005` / `S-018`, `SM-006` / `S-019`, `E-020`.  
Claims: CCHS object `2008.008.003.104` is cataloged **Main Street, Oregon City** with date range **1890 - 1899**. The photograph directly depicts a broad Main Street commercial streetscape with buildings on both sides, roadway, utility infrastructure, horse-drawn vehicles and pedestrians. The project-steward filename identifies the view as looking south from Sixth toward Fifth; this is compatible with the separate fixed-location P-1456 1890 Sixth/Main-looking-south record. If that orientation is confirmed, the east-side Fifth-to-Sixth block later containing 501/503/505 lies along the right side of the view.  
...
## E-195 — CCHS 1895 Welcome Arch photo fixes Sixth/Main and shows target predecessor frontage in right background
...
## E-234 — July 1917 continuation visually clears 24 pages and completes Courier coverage for the month
...
## E-236 — September 1917 continuation visually clears 24 pages and completes Courier coverage for the month
...
## E-290 — 29 June 1916 Courier complete visual review; June closeout
Type: Primary newspaper visual evidence / annual issue-level coverage.  
Source: `S-317`.  
Claims:
- all **8/8 pages** of the 29 June 1916 *Oregon City Courier* were visually inspected from original scans;
- page 3 directly prints **Champion Smith & Telford — 502 Main Street** and **Raasch & Lamb — Pool and Billiards / Everything for Smokers** without a street number;
- page 6 directly prints **W. W. Bradley — 507 Main**, **H. P. Brightbill — 509 Main**, and **George A. Harding — 511 Main**; the OCR's `611 Main` rendering for Harding is rejected by visual inspection and the established address sequence;
- page 7 repeats the Electric Store completed-move wording to **Andresen Building, 619 Main Street**, while retaining the stale Beaver Building / 617 Main footer;
- no exact 503 Main or 505 Main occupant, owner, tenant, licensee, sale, transfer, construction, demolition, closure or vacancy statement is printed;
...
## E-334 — 10 November 1916 Enterprise complete visual review
Type: Primary newspaper visual evidence / annual issue-level coverage  
Claims: All **8/8** page scans were visually inspected. Recurring non-target Main Street controls and printed transfer material were checked. No inspected page directly supplies a target-premises event.  
Source: `S-361`.  
Confidence: Very High for visual coverage; no-hit is bounded issue coverage only.

## E-335 — 17 November 1916 Enterprise complete visual review
Type: Primary newspaper visual evidence / annual issue-level coverage  
Claims: All **8/8** page scans were visually inspected. Recurring non-target Main Street controls and printed transfer material were checked. No inspected page directly supplies a target-premises event.  
Source: `S-362`.  
Confidence: Very High for visual coverage; no-hit is bounded issue coverage only.

...
Compare assessor sketches, permits, tax cards, Sanborn maps, deeds, parcel maps, and physical measurements to determine whether the rear portion of 505 was added later and whether 505 extends farther back than 503. **August 2026 update:** working hypothesis **`E-101`** proposes that a rear expansion or major rear remodel **might** explain the inventory **1940** date while **c.1920** may describe the front/core; this remains **unresolved**. **`E-102`** partial pass (24 August 2026): **1925 vs. 1950** Sanborn visually verified — 505 separate Main-frontage bay with **CONC. FL.** by 1950; block gas/laundry/post-office reconfiguration; **505-specific rear extension not confirmed**. Preliminary **IMG-0007/0008/0009** aerial comparison suggests block-level density change by 1940; address-level 505 transcription **still open**. **1939–1941 permits not recovered** (retrieval gap only). Remaining priority tests: Oregon City Building Division archives; assessor improvement cards **1938–1942**; steward-verified aerial rear-edge transcription; physical material/footprint analysis. See `evidence/source-captures/505-rear-expansion-1940-date-hypothesis.md` and `evidence/source-captures/505-rear-expansion-footprint-pass-2026-08-24.md`.

...
Status: **Map portion completed; tenant and footprint continuity remain open.** `E-020` / `S-021` visually establish a separate **501 store**, **503 restaurant**, and **505 billiards/cigars** use on the 1925 Sanborn. The map does not name occupants or prove continuity into later buildings. Use directories and title/assessor/permit evidence to identify the tenants and test the later footprint; see `RL-019` for the 501 occupant question.

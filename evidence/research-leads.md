...
**1910 update:** `E-081` / `S-094` lists **Geo. A. Harding at 611 Main St.** in September 1910. This is Harding's business address and is **not** automatically the Harding Building address. Use it as evidence that the building name and George Harding's own store listing must be reconstructed separately. Continue with the 1906 numbering plat, Block 26 lot mapping, deeds/tax records, directories, Sanborn maps, George Young's 1911 move from the Harding Building to the Willamette Building one door north, and later numbered Harding-related addresses.
...
Primary evidence now establishes the historic three-story frame **William Tell Hotel at Sixth & Main / lot 8, Block 26** in October 1906 (`E-064`) and a **new Gambrinus building under construction at the Gambrinus property at Sixth & Main** in June–August 1910 (`E-078`). Recover the demolition permit/report, contractor/building permit, deed/property description, insurance record, photograph, assessment change, or newspaper item that explicitly connects the old William Tell structure to the 1910 construction. Determine the demolition date and whether any part of the earlier building survived. Also test whether the 1909 Philip Street repair (`E-075`) or Hodes saloon (`E-076`, `E-079`) occupied that same property. Until then, describe the 1910 event as new construction on the Gambrinus property, not as a proven direct demolition replacement.

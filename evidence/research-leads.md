...
Use `E-064` as the fixed 1906 north-end anchor: the historic William Tell Hotel at **Sixth & Main** corresponds to **Lot 8, Block 26**. The visually verified 1913 notice (`S-107`) and official original plat (`S-108`) now establish the Main-side order from Fifth toward Sixth as **Lot 5 → Lot 6 → Lot 7 → Lot 8** and the target-area lot regime as at least **66 feet front by 100 feet back**.

`E-094` materially narrows the immediate mapping problem. A proportional reading against the printed scale on the visually verified 1925 Sanborn makes the combined **501+503+505** frontage approximately 66–67 feet, placing the first original-lot division at or very near the **505/507 wall**. The present strong working alignment is therefore **501/503/505 ≈ Lot 5; 507 begins ≈ Lot 6**. This supersedes the former 50-foot hypothesis that put 505 near the start of Lot 6.

The alignment is not yet cadastral proof. Recover a deed, title abstract, survey overlay, tax/lot book or other direct property record that fixes the line and explains the original **Block 26** / later-current **Block 4** conversion. For the July 1922 fire investigation, prioritize the Lot 5 Barlow/David title, tax and improvement-ownership chain while retaining Lot 6 / First National Bank as a secondary safeguard. Do not assume that common land ownership proves common building/improvement ownership.

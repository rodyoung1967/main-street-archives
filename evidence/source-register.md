...
Notes: Current administrative/legal record for 505 Main Street, 505 LLC, Alin Guria, lease term July 1, 2025-June 30, 2030, restaurant/bar use, NNN-style rent items, and insurance/licensing requirements.
...
Publication/date: *Oregon City Courier*, 5 January 1912 (date identified by Rodney Young).  
Related evidence: `E-050`  
Notes: Visible advertisement reads **"H. P. BRIGHTBILL"**, **"509 Main St."**, **"Phone 74"**, **"OREGON CITY"** beneath a tea advertisement. Primary evidence for Brightbill at 509 Main on this date. Binary image awaits later canonical placement under `newspapers/`.

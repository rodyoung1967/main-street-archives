...
| **1923–1936 (OHS range)** | OHS `371N5709` shows a standing structure at the steward-mapped later **503** position; storefront sign appears compatible with **CAFE**. | Strong cross-source address mapping; tentative sign reading; consistent with 1925 restaurant use. |
...
| **1 Mar. 1928** | Fire Department table records **“503 Main Res.” — Overheated Stove — None**. | **VISUALLY VERIFIED DIRECT EXACT-ADDRESS MUNICIPAL EVIDENCE** (`S-372` / `E-348`). Preserve `Res.` as printed; no Kwality/proprietor/owner/tenant identity and no whole-building residential-use inference. The 1925 Sanborn remains the earlier post-1922 building-presence control. |
| **10 Jun. 1929 / 1929** | Municipal report records **5th & Main — Wiring — $25** and separately documents **28 ornamental Main Street lights from Fifth to Ninth**, cost **$5,600**. | **VISUALLY VERIFIED INTERSECTION / PUBLIC-REALM CONTEXT** (`S-373` / `E-349`); the fire call is unnumbered and is not assigned to 503. |

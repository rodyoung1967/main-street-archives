...
| 16 May 1958 | **WHEEL CAFE & LOUNGE — 503 Main St. — Ph: 9106.** | **Exact, visually verified primary ad; earliest currently recovered exact-address Wheel advertisement.** Not an opening date; proprietor/licensee unnamed. | `BUS-004`; `E-256`; `S-283` |
...
| 7 Jun. 1967 | Commission places **the Wheel at 503 Main**. | **Exact primary municipal.** | `BUS-004`; `E-025`; `S-027` |

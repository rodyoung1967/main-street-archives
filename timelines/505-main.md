...
| By 1934 context | Edwin and Alice Farr identified as proprietors of **Farr's Pool Hall at 505**; residence acquired 1934. | High official secondary; 1934 is not business opening date. | `BUS-013`; `P-028`, `P-029`; `E-033`; `S-036` |
...
| 1940 | 2009/2021 inventories assign surviving resource 1940. | Official-secondary conflict with c.1920 and 1925 structure; rear-expansion theory unresolved. | `E-100`–`E-102`; `S-063`, `S-116` |
...
| Later 1970s–1980s | Ray Hansen earlier; Dick/Sheila later operate **Brass Rail before owning building**. | Family evidence; sale/rename dates open; Hansen is not Raye Grisham. | `BUS-005`, `BUS-010`; `E-022`, `E-031`, `E-038` |
| Later, date open | Dick/Sheila buy **505 real estate** from Mrs. Nesmeth/Nemeth. | Family evidence; separate from business ownership; deed/spelling/date open. | `P-026`; `E-038` |
| 6 Apr. 1988 | **Dug Inn (formerly Brass Rail), 505 Main** transfer application from Wiitanen to Cotterells. | **Exact primary municipal**; not property transfer or continuous-operation proof. | `BUS-010`, `BUS-016`; `E-030`; `S-041` |
...
| Before Mar. 1991 | Wiitanens regain control and rename business **505 Tavern** before sale to Mitch. | High family/participant; exact rename/license date open. | `E-004`, `E-022` |
| Mar. 1991–Mar. 2004 | Mitch/ Mitchell C. Young operates already-named **505 Tavern**. | Very high participant evidence; he did not introduce/restore name. | `P-011`, `P-018`; `E-004`; `OH-001` |
| Post-2004 | Bagent and Enstad later business leads. | Secondary leads; filings/dates needed. | `P-032`, `P-033` |
| 2009 | Berman states he bought 505 Tavern. | High municipal participant statement. | `E-034`; `S-042` |
| 2017 | Scott Forvilly purchases/reopens as **Thirsty Duck**; permit lists Richard Wiitanen as co-trustee/real-estate owner. | Business and property roles separate. | `BUS-006`; `E-008`, `E-035` |
...
| Nov. 2024 | Dick dies; 505 passes through estate to Rodney and Mitchell Young; Sheila died 2014. | Family/current stewardship; probate/deed desirable. | `E-009`, `E-022` |

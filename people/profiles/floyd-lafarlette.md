...
Person ID: `P-022`. Related business/address: `BUS-004`, `B-001`.
...
Rodney Young clarified on **7 September 2026** that the later **Floyd LaFarlette in Arkansas is the same Floyd LaFarlette** who was Raye's husband, not a same-name person who should be split from him. Rodney's family recollection is that **Raye and Floyd met in Memphis**, then went to **Chicago**; their exact place of marriage was previously unresolved. Rodney further clarified that **Raye and Floyd were still together during their Oregon City period**. Their Oregon City presence therefore belongs **before** their divorce and before Floyd's return to Arkansas. After Raye and Floyd divorced, **Floyd moved back to Arkansas**. Classification: **PROJECT-STEWARD / FAMILY ORAL-HISTORY EVIDENCE** for the meeting, movement, Oregon City relationship status, divorce-order, and return-to-Arkansas sequence.

A newly recovered **Cross County, Arkansas marriage index** supplies a separate documentary lead for the marriage itself: it lists **Floyd LaFarlette, age 35**, and **Raye Weaver, age 24**, married **6 July 1943**, index **B-1432**. The underlying county marriage record has not yet been recovered or visually inspected, so classify the place/date as **SECONDARY/INDEXED RECORD — STRONG IDENTITY AND MARRIAGE-LOCATION LEAD, NOT SCAN-CERTIFIED PRIMARY PROOF**. See `evidence/source-captures/1943-floyd-lafarlette-raye-weaver-marriage-index-control-2026-09-07.md`. This indexed marriage control does not establish where they met, when they moved to Chicago, or any later Wheel role.

## Pre-Wheel business record

Floyd's business history is now independently documented outside The Wheel context.

- A visually reviewed **18 October 1951 Coquille Valley Sentinel** advertisement directly identifies **Charlie Elkins and Floyd LaFarlette as the new owners of The Myrtle Lodge**, a steaks/seafood/chicken establishment advertising Saturday-night dancing from 10 p.m. to 1 a.m.
- A visually reviewed **11 June 1953 Coquille Valley Sentinel** article names **Mr. and Mrs. Floyd LaFarlette** among the hosts of a banquet and dance at The Myrtle Lodge.
- Indexed/OCR *Myrtle Point Herald* text from **16 August 1962** identifies Floyd with ownership of the **Myrtle Hotel**, its **coffee shop**, and **Lehua** in Myrtle Point.
- Indexed/OCR text from the **21 February 1963** article “Myrtle Hotel Begins Major Renovation This Week” explicitly places **Mr. and Mrs. Floyd LaFarlette** in the owner/renovation context and associates the article with **Myrtle Hotel, Myrtle Coffee Shop, and Club Lehua**.
- Indexed text from **6 May 1965** calls Floyd an **operator** in connection with Myrtle Hotel building plans.

The 1962–65 Myrtle Point items remain **OCR/TEXT ONLY** because the NewspaperArchive page images were not accessible in the present research environment. Their exact legal wording must be visually verified before assigning a definitive ownership interest to Raye or treating Club Lehua as a separately owned entity.

The Myrtle Lodge and Myrtle Hotel / Club Lehua must remain separate unless contemporary evidence explicitly bridges them: The Myrtle Lodge was on the Highway 101 corridor between Coquille and Coos Bay, while the later hotel/nightlife cluster is explicitly in Myrtle Point.

Full research capture: `evidence/source-captures/raye-floyd-lafarlette-pre-wheel-hospitality-businesses-2026-09-05.md`.

## Morton, Washington chronology lead

Rodney Young and Mitch Young independently remember that Floyd and Raye spent time in **Morton, Washington before Coquille**, with Mitch saying that Sheila was not yet of school age and that, as far as he knew, the family came to Morton from Chicago. Rodney separately remembers Raye working at the Morton Wheel Cafe and a possible later ownership connection between that business and The Wheel in Oregon City.

This remains **FAMILY / ORAL-HISTORY EVIDENCE**. It conflicts with the visually rechecked **11 March 1954 Coquille Valley Sentinel** profile in which Raye described the family's 1944 westward sequence as returning to Chicago after a Coos County vacation, selling the Chicago rooming-house business, and moving to Coquille without mentioning Morton.

The strongest current documentary endpoint is **7 August 1947**, when a visually reviewed *Coquille Valley Sentinel* page reports the trucking firm **Anderson and LaFarlette** receiving the Coos Bay–Powers mail contract. Later evidence identifies Floyd as the LaFarlette partner. Sheila's published obituary reports that she was born **13 June 1944**.

If the remembered Chicago → Morton → Coquille sequence is substantially correct, the highest-value **working search bracket** is therefore **13 June 1944 through 7 August 1947**, with Sheila roughly age 0–3. This is a research bracket, not a documented Morton residence. No contemporary Morton address, employment record, business role, or Wheel proprietor link for Floyd has yet been recovered.

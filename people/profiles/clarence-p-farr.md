...
A 23 June 1911 *Oregon City Courier* legal notice explicitly names **Clarence P. Farr** as executor of Isaac Farr's estate (`S-274` / `E-248`). Oregon City's official Farr Store history independently identifies Clarence Farr with the local Farr Brothers / 919 7th Street family and property context (`S-275`).

...
Earlier archive notes recorded `P-006` as **Ray Grisham**, possibly a male 505 / The Wheel owner/operator, and kept that name distinct from Ray Hansen (`P-005`) because the two might have been a memory conflict.
...
- She **bought The Wheel at 503 Main Street** (`BUS-004`).
- **The Wheel was only at 503 Main and never at 505 Main.**
- She is **not** the same person as **Ray Hansen** (`P-005`), who belongs to the separate 505 Tavern history.
...
This remains **FAMILY / ORAL-HISTORY EVIDENCE**, not documentary proof. Sheila's published obituary reports a birth date of **13 June 1944**. Rodney additionally states from family knowledge that **Sheila was born in Chicago**; because the obituary does not provide birthplace and no birth certificate is yet in the archive, Chicago is retained as **PROJECT-STEWARD / FAMILY PROVENANCE**. If accurate, that means the family was still in Chicago on 13 June 1944 and any Chicago → Morton move came afterward. The visually rechecked 11 March 1954 *Coquille Valley Sentinel* profile says Sheila was 9 and gives Raye's own contemporary move account as **Chicago → Coquille in 1944**, without mentioning Morton. Floyd is independently documented in a southern Coos County business by **7 August 1947**.
...
By August 1985, independent newspaper evidence identifies **Richard M. Wiitanen as owner of The Wheel Cafe at 503 Main** (`E-049`). That establishes the later endpoint but does not by itself establish when or how the business passed from Raye.

Dick and Sheila also owned the **505 real estate** during at least part of their Wheel period. That property overlap must not be interpreted as combining The Wheel with the 505 tavern business or as proof they ordinarily operated the 505 tavern. Current family clarification says any Wiitanen control of the 505 business may have occurred only briefly during repossession/default or a transfer interval.
...
Rodney Young stated on **6 September 2026** that he **believes Raye and Floyd LaFarlette lived in Powers, Oregon**. Preserve this as **PROJECT-STEWARD / FAMILY ORAL-HISTORY LEAD**. Existing 1947–48 records independently tie the LaFarlette family/business network to Powers and include an OCR/text-only `Ray LaFarlette, Powers` community reference, but no contemporary household address has yet been scan-certified. Powers should therefore be treated as a high-value residence-search target, not as an established residence fact.
